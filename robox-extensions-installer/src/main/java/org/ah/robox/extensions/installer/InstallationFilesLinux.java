...
*/
public enum InstallationFilesLinux implements InstallationFile {
    ...
    InstallationFilesLinux(String localPath, String repoPath, boolean isDir, boolean delete, boolean executable) {
