...
*/
public enum InstallationFilesOSX implements InstallationFile {
    ...
    InstallationFilesOSX(String localPath, String repoPath, boolean isDir, boolean delete, boolean executable) {
