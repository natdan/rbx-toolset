 ...
 */
public class RxTxPrinterDiscovery extends BasePrinterDiscovery {

    {
        SharedLibraries.load("rxtxSerial");
    }

    public RxTxPrinterDiscovery() {
    }
    ...
    private void discoverSerialDevice(List<PrinterChannel> printerChannels, String devName) throws IOException {
        try {
            ...
            if (channel != null) {
                ...
                RxTxSerialPortPrinterChannel printerChannel = new RxTxSerialPortPrinterChannel(devName);
